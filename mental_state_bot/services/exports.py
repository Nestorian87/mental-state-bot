        ...
        writer.writerow(
            {
                ...
                "entry_type": features.get("entry_type") or "",
                "activity_labels": _csv_list(features.get("activity_labels")),
                "state_labels": _csv_list(features.get("state_labels")),
                "emotion_labels": _csv_list(features.get("emotion_labels")),
                "affective_states": _csv_list(features.get("affective_states")),
                "mood": _feature_value(features.get("mood")),
                "mood_confidence": _feature_confidence(features.get("mood")),
                "mood_evidence": features.get("mood_evidence") or "",
                "mood_reasoning_type": features.get("mood_reasoning_type") or "",
                "should_graph_mood": features.get("should_graph_mood"),
                "energy": _feature_value(features.get("energy")),
                "energy_confidence": _feature_confidence(features.get("energy")),
                "energy_evidence": features.get("energy_evidence") or "",
                "energy_reasoning_type": features.get("energy_reasoning_type") or "",
                "should_graph_energy": features.get("should_graph_energy"),
                "anxiety": _feature_value(features.get("anxiety")),
                "anxiety_confidence": _feature_confidence(features.get("anxiety")),
                "anxiety_evidence": features.get("anxiety_evidence") or "",
                "anxiety_reasoning_type": features.get("anxiety_reasoning_type") or "",
                "used_context": features.get("used_context"),
                "context_inference": features.get("context_inference") or "",
                "needs_clarification": features.get("needs_clarification"),
                "clarification_question": features.get("clarification_question") or "",
